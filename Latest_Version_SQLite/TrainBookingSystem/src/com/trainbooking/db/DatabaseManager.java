...
public class DatabaseManager {
    ...
    public void seedSampleData() throws SQLException {
        ...
        String[][] trains = {
            ...
            {"IE104", "Belfast Express",     "Dublin",  "Belfast",   "2025-05-01 10:00:00", "2025-05-01 12:00:00", "100", "22.00"},
            {"IE105", "Limerick Connect",    "Dublin",  "Limerick",  "2025-05-01 11:00:00", "2025-05-01 13:00:00", "60",  "30.00"},
            {"IE106", "Waterford Intercity", "Dublin",  "Waterford", "2025-05-01 12:00:00", "2025-05-01 14:00:00", "60",  "25.00"},
    ...
    public List<String> getDistinctOrigins() throws SQLException {
        ...
        while (rs.next()) origins.add(rs.getString(1));
        return origins;
    }
    ...
    public List<String> getDistinctDestinations() throws SQLException {
        ...
        while (rs.next()) dests.add(rs.getString(1));
        return dests;
    }
