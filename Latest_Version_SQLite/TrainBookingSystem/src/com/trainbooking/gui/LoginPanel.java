...
public class LoginPanel extends JPanel {
    ...
    public LoginPanel(MainFrame mainFrame, UserService userService) {
        ...
        tabbedPane.setPreferredSize(new Dimension(420, 340));
    ...
    private JPanel buildRegisterTab() {
        ...
        gbc.gridy = 0; panel.add(makeLabel("Full Name:"), gbc);
        gbc.gridy = 1; regFullNameField = new JTextField(); styleTextField(regFullNameField); panel.add(regFullNameField, gbc);

        gbc.gridy = 2; panel.add(makeLabel("Email:"), gbc);
        gbc.gridy = 3; regEmailField = new JTextField(); styleTextField(regEmailField); panel.add(regEmailField, gbc);

        gbc.gridy = 4; panel.add(makeLabel("Username:"), gbc);
        gbc.gridy = 5; regUsernameField = new JTextField(); styleTextField(regUsernameField); panel.add(regUsernameField, gbc);

        gbc.gridy = 6; panel.add(makeLabel("Password:"), gbc);
        gbc.gridy = 7; regPasswordField = new JPasswordField(); styleTextField(regPasswordField); panel.add(regPasswordField, gbc);

        gbc.gridy = 8; panel.add(makeLabel("Confirm Password:"), gbc);
        gbc.gridy = 9; regConfirmPasswordField = new JPasswordField(); styleTextField(regConfirmPasswordField); panel.add(regConfirmPasswordField, gbc);
